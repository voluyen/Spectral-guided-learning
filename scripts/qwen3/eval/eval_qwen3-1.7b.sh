#!/usr/bin/env bash
# Phase 6: eval a Qwen3-1.7B LoRA adapter with vLLM, Pass@1. Default checkpoint is the spectral
# run -- pass the vanilla checkpoint path + a tag to eval that one instead.
#   ./scripts/qwen3/eval/eval_qwen3-1.7b.sh
