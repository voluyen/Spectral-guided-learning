#!/usr/bin/env bash
# Phase 2: data prep for the Qwen3-1.7B track.
set -euo pipefail
...
OUTPUT_PATH="data/qwen3-1.7b/train-s1k-segmented.jsonl"
N_SAMPLES=1050
MAX_TOKENS=32768
...
echo "${CMD}"
${CMD} 2>&1 | tee logs/qwen3-1.7b-data.log
