...
DATA_PATH="${BASE_PATH}/data/qwen3-8b/train-s1k-segmented.jsonl"
WEIGHTS_PATH="${BASE_PATH}/data/qwen3-8b/prucot-weights.parquet"
TOKENIZER="Qwen/Qwen3-8B"
PRUNING_AGENT="Qwen/Qwen2.5-7B-Instruct"
OUTPUT_PATH="${BASE_PATH}/data/qwen3-8b/train-prucot.jsonl"
...
echo "${CMD}"
${CMD} 2>&1 | tee "${BASE_PATH}/logs/qwen3-8b-prucot-prune.log"
